...
This repository contains an implementation of S3Kv1 written in C. This is a reference implementation for [S3Kv1 rewritten in Barocq](https://github.com/cchavano/s3k-barocq).
